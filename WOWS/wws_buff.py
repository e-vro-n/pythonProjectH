...
#
# def ave_kr_100(dmg_my, battle, lvl, plan):
#     if lvl == 8:
#         c8 = 0
#         prom_ave = dmg_my * battle
#         print('gg 88', prom_ave, 'avvvv', round(prom_ave / battle, 2))
...
#         c8 = 0
#         prom_ave = dmg_my * battle
#         print('gg 99', prom_ave, 'avvvv', round(prom_ave / battle, 2))
#         while (prom_ave / battle) < 83000:
#             prom_ave += plan
#             battle += 1
#             c8 += 1
#             print('prom', prom_ave, 'AW', round(prom_ave / battle, 1), 'bat', battle, 'c8', c8)
...
#
#
# def ave_lk_100(dmg_my, battle, lvl, plan):
#     pass
#
#
# def ave_esm_100(dmg_my, battle, lvl, plan):
#     pass
#
#
...
#     if cls == 'k':
#         rez.append(ave_kr_100(info[1], info[2], info[0], info[-1]))
#         rez_dic['Крейсера ' + str(info[0]) + '-го уровня'] = ave_kr_100(info[1], info[2], info[0], info[-1])
#         # print('rez', rez)
#         print('рез_Кр', rez_dic)
#     if cls == 'l':
#         rez.append(ave_lk_100(info[1], info[2], info[0], info[-1]))
#         rez_dic[f"Линкоры {str(info[0])}-го уровня"] = ave_lk_100(info[1], info[2], info[0], info[-1])
#         # print('rez', rez)
#         print('рез_Лк', rez_dic)
#         pass
#     if cls == 'e':
#         rez.append(ave_esm_100(info[1], info[2], info[0], info[-1]))
#         rez_dic[f"Эсминцы {str(info[0])}-го уровня"] = ave_esm_100(info[1], info[2], info[0], info[-1])
#         # print('rez', rez)
...
def dmg100(dmg_my,battle,plan, clas, lvl):
    prom_ave = dmg_my * battle
    btls = 0
